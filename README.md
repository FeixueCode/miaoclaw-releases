...
最新：v3.1.12 · 免费软件 · 数据全在本机 · 模型你自选（DeepSeek / Kimi / GLM / Qwen 等 60+ 家）
...
- **## 新增与改进**：**接入外部工具（第一阶段）**：现在可以在本机设置中接入外部工具，让 Miaoclaw 调用它们完成工作
- **## 你需要做什么**：**电脑**：本次必须安装完整更新包
- **## 已知限制**：外部工具目前只提供“调用外部工具”这一阶段；暂不把 Miaoclaw 提供成外部服务，也暂未覆盖资源浏览、提示模板等完整…

完整更新说明见 [Releases](https://github.com/FeixueCode/miaoclaw-releases/releases/tag/v3.1.12)。
...
Latest: v3.1.12 · Free · Local-first · Bring your own model key (60+ providers supported)
