...
最新：v3.3.1 · 免费软件 · 数据全在本机 · 模型你自选（DeepSeek / Kimi / GLM / Qwen 等 60+ 家）
...
- **3.3.1**：**搜索回答更方便核对**：来源随回答保留，关键结论旁可点击原文；相关图片可直接展示，并保留图源
- **你需要做什么**：**要不要重启**：安装本版完整更新包后，从托盘完全退出 Miaoclaw 再打开；只关闭窗口不算完全退出

完整更新说明见 [Releases](https://github.com/FeixueCode/miaoclaw-releases/releases/tag/v3.3.1)。
...
Latest: v3.3.1 · Free · Local-first · Bring your own model key (60+ providers supported)
